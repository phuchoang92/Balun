...
public:
		...
		: Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		m_Shader.reset(new Balun::Shader(vertexSrc, fragmentSrc));
		...
		m_BlueShader.reset(new Balun::Shader(blueShaderVertexSrc, blueShaderFragmentSrc));
	}
	...
	void OnUpdate() override
	{
		...
		Balun::Renderer::Submit(m_BlueShader, m_SquareVertexArray);
...
private:
	...
	std::shared_ptr<Balun::Shader> m_BlueShader;
